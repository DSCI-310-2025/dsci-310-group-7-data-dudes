...
```{r}
#| echo: false
# show the first 3 columns of data
data <- read.csv("data/data-cleaned-transformed.csv")
head(data, 1)
```
...
![Proportion of individuals in each age group who have consumed alcohol in the past 12 months](output/eda/eda-alcohol.png)

We also applied the same approach to examine marijuana use over the same period:

![Proportion of individuals in each age group who have used marijuana in the past 12 months](output/eda/eda-marijuana.png)
...
![Proportion of individuals in each age group who have used heroin in the past 12 months](output/eda/eda-heroin.png)
...
![Relationship between frequency of heroin use vs. frequency of marijuana use](output/eda/eda-heroin-marijuana.png)

Finally, let's look at some EDA that compares the two main groups we are looking at: youth and adult.

![Comparing Substance Use between Adults and Youth](output/eda/eda-all-use.png)

Some of these results are expected, such as the adults drinking more alcohol than the youth.

![Comparing Frequency Use between Adults and Youth](output/eda/eda-all-freq.png)
...
![Confusion Matrix: Decision Tree](output/confusion-matrix_decision-tree.png){width=50%}

\newpage

2. K Nearest Neighbours (KNN)

![Confusion Matrix: KNN](output/confusion-matrix_knn.png){width=50%}

3. Logistic Regression

![Confusion Matrix: Logistic Regression](output/confusion-matrix_logistic-regression.png){width=50%}

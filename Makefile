...
analysis:
	...
	Rscript scripts/03-eda.R --file_path_drug=data/clean/data-cleaned.csv --file_path_age=data/data_cleaned_transformed.csv --output_path=output/eda
	Rscript scripts/04-analysis.R --data=data/clean/data-cleaned.csv --output_prefix=output/results

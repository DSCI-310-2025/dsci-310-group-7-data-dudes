...
Since we aim to investigate whether substance use during adolescence can predict substance use patterns later in life,
...
To further explore the use of harder substances, such as heroin, crack and hallucinogens,
...
data <- data %>%
  mutate(heroin.frequency = as.numeric(heroin.frequency))

...
![Proportion of individuals in each age group who have consumed alcohol in the past 12 months](output/eda-alcohol.png){#fig-alcohol}

We also applied the same approach to examine marijuana use over the same period:

![Proportion of individuals in each age group who have used marijuana in the past 12 months](output/eda-marijuana.png){#fig-marijuana}
...
![Proportion of individuals in each age group who have used heroin in the past 12 months](output/eda-heroin.png){#fig-heroin}
...
![Relationship between frequency of heroin use vs. frequency of marijuana use](output/eda-heroin-marijuana.png){#fig-heroin_marijuana}

Finally, let's look at some EDA that compares the two main groups we are looking at: youth and adult.

![Comparing Substance Use between Adults and Youth](output/eda-all-use.png){#fig-sub-use}

Some of these results are expected, such as the adults drinking more alcohol than the youth.

![Comparing Frequency Use between Adults and Youth](output/eda-all-freq.png){#fig-freq-use}
...
![Confusion Matrix: Decision Tree](output/confusion-matrix_decision-tree.png){#fig-tree-matrix width=50%}

2. K Nearest Neighbours (KNN)

![Confusion Matrix: KNN](output/confusion-matrix_knn.png){#fig-knn-matrix width=50%}

3. Logistic Regression

![Confusion Matrix: Logistic Regression](output/confusion-matrix_logistic-regression.png){#fig-log-matrix width=50%}
